GRAPH_TEMPLATES = {
    "direct_connections": {
        ...
        "cypher": """
            MATCH (n:Entity {project: $project})-[r:CONNECTED_TO {project: $project}]-(m:Entity {project: $project}) 
    ...
    "deep_context": {
        ...
        "cypher": """
            MATCH (n:Entity {project: $project})-[r1:CONNECTED_TO {project: $project}]-(m:Entity {project: $project})-[r2:CONNECTED_TO {project: $project}]-(o:Entity {project: $project})
            WHERE toLower(n.id) CONTAINS toLower($entity)
    ...
    "shortest_path": {
        ...
        "cypher": """
            MATCH (n:Entity {project: $project}), (m:Entity {project: $project})
            WHERE toLower(n.id) CONTAINS toLower($entity1) AND toLower(m.id) CONTAINS toLower($entity2)
            MATCH p = shortestPath((n)-[:CONNECTED_TO*1..4]-(m))
            WHERE ALL(r IN relationships(p) WHERE r.project = $project)
    ...
    "shared_connections": {
        ...
        "cypher": """
            MATCH (n:Entity {project: $project})-[r1:CONNECTED_TO {project: $project}]-(common:Entity {project: $project})-[r2:CONNECTED_TO {project: $project}]-(m:Entity {project: $project})
            WHERE toLower(n.id) CONTAINS toLower($entity1) AND toLower(m.id) CONTAINS toLower($entity2)
    ...
    "relationship_search": {
        ...
        "cypher": """
            MATCH (n:Entity {project: $project})-[r:CONNECTED_TO {project: $project}]-(m:Entity {project: $project})
            WHERE toLower(r.type) CONTAINS toLower($action_verb) AND toLower(n.id) CONTAINS toLower($entity)
            RETURN n.id AS source, r.type AS relation, m.id AS target, r.source_text AS narrative
            LIMIT 20
        """,
    ...
    "top_hubs": {
        ...
        "cypher": """
            MATCH (n:Entity {project: $project})-[r:CONNECTED_TO {project: $project}]-()
