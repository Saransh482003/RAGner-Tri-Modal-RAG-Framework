...
def retrieve_context(client: QdrantClient, collection_name: str, query: str, embedder, reranker, strategy: str = "vanilla", bi_encoder_top_k: int = 15, cross_encoder_top_k: int = 3) -> List[Dict[str, Any]]:
    """
